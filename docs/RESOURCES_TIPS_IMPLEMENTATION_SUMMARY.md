...
> **Note:** The `ResourcesScreen` described in this document has been replaced by
> `src/frontend/screens/bloom/BloomScreen.tsx` (the "Bloom" tab). References below
> to `ResourcesScreen` and `resourcesStore` are historical.
